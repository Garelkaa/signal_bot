...
- При регистрации введите промокод который даст +500% к депозиту, инструкция по регистрации ниже 👇""",
        ...
        instructions = (
            "❕<b>1. Зарегистрируйтесь в букмекерской конторе</b> <a href='https://1wsewz.com/?open=register&p=cygp'>1WIN</a>\n"
            ...
            "- ❗️Введите промокод - <code>MEGAslot500</code> - он даст +500% к депозиту❗️\n"
            "\n"
